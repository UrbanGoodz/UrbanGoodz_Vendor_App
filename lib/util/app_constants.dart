...
class AppConstants {
  ...
  static const String ugAiRecommendationsUri = '/api/v1/urban-goodz/ai/recommendations';
  static const String ugIdentityProfilesUri = '/api/v1/urban-goodz/identity/profiles';
  static const String ugFitProfileUri = '/api/v1/urban-goodz/identity/fit-profile';
  static const String ugIdentityGrantsUri = '/api/v1/urban-goodz/identity/grants';
  ...
  static const String ugReelsConversionUri = '/api/v1/urban-goodz/reels/conversion';
  static const String ugReelsOpportunitiesUri = '/api/v1/urban-goodz/reels/opportunities';
  static const String ugReelsAnalyticsUri = '/api/v1/urban-goodz/reels/analytics';
  static const String ugOpportunityNetworkListUri = '/api/v1/urban-goodz/opportunities';
  static const String ugOpportunityNetworkDetailUri = '/api/v1/urban-goodz/opportunities';
  static const String ugOpportunityNetworkAcceptUri = '/api/v1/urban-goodz/opportunities/accept';
  static const String ugOpportunityNetworkDeclineUri = '/api/v1/urban-goodz/opportunities/decline';
  static const String ugOpportunityNetworkCompleteUri = '/api/v1/urban-goodz/opportunities/complete';
  static const String ugRevenueAttributionsUri = '/api/v1/urban-goodz/revenue/attributions';
  static const String ugRevenueRecordUri = '/api/v1/urban-goodz/revenue/record';
  static const String ugRevenueAnalyticsUri = '/api/v1/urban-goodz/revenue/analytics';
