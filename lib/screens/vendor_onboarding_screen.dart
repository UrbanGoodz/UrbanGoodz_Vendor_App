...
class _VendorOnboardingScreenState extends State<VendorOnboardingScreen> {
  ...
  // Login Controllers
  final _loginEmailController = TextEditingController(text: 'sarah.tailor@urbangoodz.com');
  ...
  final _regEmailController = TextEditingController(text: 'sarah.tailor@urbangoodz.com');
  final _regPhoneController = TextEditingController(text: '+1 (713) 555-0200');
  ...
  final _addressController = TextEditingController(text: 'Heights Studio, Suite 104, Houston, TX');
