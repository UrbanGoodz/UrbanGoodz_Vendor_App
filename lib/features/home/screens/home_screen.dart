...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildAIConciergeCard(BuildContext context) {
    return Padding(
  ...
  Widget _buildMembershipCard(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(Dimensions.radiusExtraLarge),
        onTap: () => Get.toNamed(RouteHelper.getUrbanGoodzPlusRoute()),
        child: Container(
          width: double.infinity,
          padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
          decoration: BoxDecoration(
  ...
  Widget _buildRentalsCard(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeSmall : Dimensions.paddingSizeDefault,
        vertical: Dimensions.paddingSizeSmall,
  ...
  Widget _buildLocalEventsCard(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeSmall : Dimensions.paddingSizeDefault,
        vertical: Dimensions.paddingSizeSmall,
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(Dimensions.radiusExtraLarge),
        onTap: () => Get.toNamed(RouteHelper.getLocalEventsCreatorsRoute()),
        child: Container(
          width: double.infinity,
          padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
          decoration: BoxDecoration(
              ...
              child: ResponsiveHelper.isDesktop(context) ? WebNewHomeScreen(
                ...
                slivers: [
                  ...
                  if (splashController.module == null && !showMobileModule && !hasModuleQuery && !isTaxi && !isRide) ...[
                    ...
                    SliverToBoxAdapter(child: _buildLocalEventsCard(context)),
                  ],
