...
class FashionMeasurementHomeScreen extends StatefulWidget {
  ...
  @override
  State<FashionMeasurementHomeScreen> createState() => _FashionMeasurementHomeScreenState();
}

class _FashionMeasurementHomeScreenState extends State<FashionMeasurementHomeScreen> {
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (request.stylistNotes != null && request.stylistNotes!.isNotEmpty) ...[
                                          const SizedBox(height: 6),
                                          Text(
                                          ...
                                          Text(
                                            ...
                                            style: robotoRegular.copyWith(fontSize: 12, color: Colors.grey.shade700, height: 1.35),
                                          ),
                                        ],
                                        if (request.quoteAmount != null) ...[
                                          ...
                                          Text(
                                            ...
                                            style: robotoBold.copyWith(fontSize: 12, color: Colors.green.shade700),
                                          ),
                                        ],
                                        const SizedBox(height: 6),
                                        Text(
