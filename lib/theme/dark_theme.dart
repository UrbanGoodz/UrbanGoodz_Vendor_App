...
ThemeData dark({Color color = const Color(0xFFED9914)}) => ThemeData(
  ...
  tabBarTheme: const TabBarThemeData(dividerColor: Colors.transparent), colorScheme: ColorScheme.dark(primary: const Color(0xFFED9914), secondary: const Color(0xFF161616)).copyWith(surface: const Color(0xFF161616)).copyWith(error: const Color(0xFFdd3135)).copyWith(surface: const Color(0xFF161616)),
);