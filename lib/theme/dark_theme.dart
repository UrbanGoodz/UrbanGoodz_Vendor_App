...
ThemeData dark({Color color = const Color(0xFFC49A35)}) => ThemeData(
  ...
  tabBarTheme: const TabBarThemeData(dividerColor: Colors.transparent), colorScheme: ColorScheme.dark(primary: color, secondary: color).copyWith(surface: const Color(0xFF191A26)).copyWith(error: const Color(0xFFdd3135)).copyWith(surface: const Color(0xFF111111)),
);