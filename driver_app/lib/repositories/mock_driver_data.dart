...
class MockDashboardRepository {
  ...
  Future<List<DriverJobModel>> fetchActiveJobsList() =>
      MockJobRepository().fetchActiveJobs();
...
class MockJobRepository {
  Future<List<DriverJobModel>> fetchActiveJobs() async {
    try {
      ...
      final response = await getConnect.get(
        'https://admin.urbangoodzdelivery.com/api/v1/order-anywhere/driver/available',
      );
      if (response.status.isOk &&
          response.body != null &&
          response.body['data'] != null) {
        final rawData = response.body['data'];
        final List<dynamic> list = (rawData is Map && rawData['data'] != null)
            ? rawData['data']
        ...
        return list.map((json) {
          ...
          final quoteAmount =
              double.tryParse(json['quote_amount']?.toString() ?? '0.0') ?? 0.0;
          final finalAmount =
              double.tryParse(json['final_amount']?.toString() ?? '0.0') ?? 0.0;
          final budgetEstimate =
              double.tryParse(json['budget_estimate']?.toString() ?? '0.0') ??
              0.0;
          final earnings = finalAmount > 0
              ? finalAmount
              : (quoteAmount > 0 ? quoteAmount : budgetEstimate);

          return DriverJobModel(
            id: id,
            type: 'order_anywhere',
            title:
                'Order Anywhere - ${json['store_vendor_name'] ?? 'Custom Run'} ($requestNumber)',
            description:
                json['request_details'] ??
                'Custom Order Anywhere request details.',
            pickupAddress:
                json['store_vendor_address_or_website'] ?? 'Pickup Store',
  ...
  Future<List<DriverJobModel>> fetchAvailableLoads() async => [
    DriverJobModel(
      ...
      description:
          'Full pallet of organic Urban Goodz products for a health food store in Katy.',
      pickupAddress:
          'Urban Goodz Distribution - 5500 N Sam Houston Pkwy, Houston, TX 77041',
    ...
    DriverJobModel(
      ...
      description:
          'Mixed pallet of Urban Goodz craft beverages and cold-pressed juices for a Montrose cafe.',
      pickupAddress:
          'Urban Goodz Warehouse - 7200 Harrisburg Blvd, Houston, TX 77011',
    ...
    DriverJobModel(
      ...
      description:
          'Three pallets of dry goods and pantry staples for a community food cooperative.',
      pickupAddress:
          'Urban Goodz Logistics Center - 8900 East Fwy, Houston, TX 77029',
    ...
    DriverJobModel(
      ...
      description:
          'Temperature-controlled delivery of perishable Urban Goodz items to Medical Center restaurants.',
      pickupAddress:
          'Urban Goodz Cold Storage - 1500 Canal St, Houston, TX 77003',
...
class MockEarningsRepository {
  Future<List<EarningsModel>> fetchDailyEarnings() async => [
    EarningsModel(
      date: '2026-06-08',
      amount: 187.50,
      source: 'Downtown Grocery Delivery',
      jobId: 'DJ-1001',
      status: 'completed',
      tips: 5.00,
      bonuses: 0.0,
    ...
    EarningsModel(
      date: '2026-06-08',
      amount: 35.00,
      source: "Medical Supply - Texas Children's",
      jobId: 'DJ-1002',
      status: 'completed',
      tips: 0.0,
      bonuses: 10.00,
    ...
    EarningsModel(
      date: '2026-06-08',
      amount: 52.75,
      source: 'Warehouse to Retail Restock',
      jobId: 'DJ-1003',
      status: 'in_progress',
      tips: 0.0,
      bonuses: 0.0,
    ...
    EarningsModel(
      date: '2026-06-07',
      amount: 245.00,
      source: 'Weekend Farmers Market Delivery',
      jobId: 'DJ-0997',
      status: 'completed',
      tips: 15.00,
      bonuses: 20.00,
    ...
    EarningsModel(
      date: '2026-06-07',
      amount: 32.25,
      source: 'Rice Village Restaurant Supply',
      jobId: 'DJ-0998',
      status: 'completed',
      tips: 4.50,
      bonuses: 0.0,
    ...
    EarningsModel(
      date: '2026-06-06',
      amount: 178.50,
      source: 'Memorial Area Grocery Run',
      jobId: 'DJ-0995',
      status: 'completed',
      tips: 12.00,
      bonuses: 0.0,
    ...
    EarningsModel(
      date: '2026-06-06',
      amount: 210.25,
      source: 'Galleria Mall Vendor Restock',
      jobId: 'DJ-0996',
      status: 'completed',
      tips: 8.75,
      bonuses: 15.00,
    ...
    EarningsModel(
      date: '2026-06-05',
      amount: 198.00,
      source: 'Heights Neighborhood Delivery',
      jobId: 'DJ-0994',
      status: 'completed',
      tips: 10.50,
      bonuses: 5.00,
...
class MockOpportunityRepository {
  Future<List<OpportunityModel>> fetchOpportunities() async => [
    OpportunityModel(
      ...
      description:
          'Complete 15 deliveries between June 12-14 and earn an extra \$150 bonus. Houston metro area only.',
      type: 'bonus',
      reward: 150.00,
      status: 'available',
      ...
      terms:
          'Must complete 15 deliveries within the promotional period. Bonus applied within 48 hours.',
      isActive: true,
    ),
    OpportunityModel(
      id: 'OP-002',
      ...
      description:
          'Elevated demand in Texas Medical Center area. Earn 1.5x base pay on all deliveries within the zone.',
      type: 'surge',
      reward: 0.0,
      status: 'active',
      ...
      terms:
          'Surge pricing applies automatically to all jobs originating or ending in the Medical Center zone.',
      isActive: true,
    ),
    OpportunityModel(
      id: 'OP-003',
      ...
      description:
          'Refer a qualified driver to join the Urban Goodz fleet. You get \$200 once they complete 20 deliveries.',
      type: 'referral',
      reward: 200.00,
      status: 'available',
      ...
      terms:
          'Referred driver must pass background check and complete 20 deliveries within 60 days.',
      isActive: true,
    ),
    OpportunityModel(
      id: 'OP-004',
      ...
      description:
          'Complete the Urban Goodz Safe Driving Course and earn a \$75 completion bonus.',
      type: 'training',
      reward: 75.00,
      status: 'available',
      ...
      terms:
          'Course takes approximately 45 minutes. Must pass the final assessment with 80% or higher.',
      isActive: true,
    ),
    OpportunityModel(
      id: 'OP-005',
      ...
      description:
          'Complete 10 deliveries in a single day and earn a \$50 same-day bonus.',
      type: 'bonus',
      reward: 50.00,
      status: 'available',
      validFrom: '2026-06-01',
      ...
      terms:
          'Streak resets at midnight. All 10 deliveries must be accepted and completed on the same calendar day.',
      isActive: true,
    ),
    OpportunityModel(
      id: 'OP-006',
      ...
      description:
          'New customer demand surge in Katy and Cypress areas. 1.75x earnings for all deliveries in these zones.',
      type: 'surge',
      reward: 0.0,
      status: 'active',
      validFrom: '2026-06-01',
      ...
      terms:
          'Automatic surge pricing for jobs in Katy and Cypress ZIP codes 77494, 77449, 77433.',
      isActive: true,
    ),
    OpportunityModel(
      id: 'OP-007',
      ...
      description:
          'Complete deliveries between 5:00 AM and 8:00 AM and earn an additional \$3 per delivery.',
      type: 'bonus',
      reward: 3.00,
      status: 'claimed',
      validFrom: '2026-06-01',
      validUntil: '2026-06-30',
      terms:
          'Per-delivery bonus stacked on top of regular earnings. Only applies to jobs accepted during the window.',
      isActive: true,
    ),
    OpportunityModel(
      id: 'OP-008',
      ...
      description:
          'Maintain a 4.9+ rating for the month and earn a \$100 quality service bonus.',
      type: 'bonus',
      reward: 100.00,
      status: 'completed',
      ...
      terms:
          'Based on customer ratings from completed deliveries. Minimum 30 deliveries required to qualify.',
      isActive: false,
    ),
  ];
